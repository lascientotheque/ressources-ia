# Carnet de ressources pédagogiques sur l'intelligence artificielle pour les jeunes publics 
...
* en utilisant directement le [dépôt Github](https://github.com/lascientotheque/ressources-ia). Si vous ne connaissez pas Github, regardez [cette vidéo pour voir comment ouvrir une discussion ou modifier le contenu de ce site](). Ou
